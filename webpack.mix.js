...
.js(
    ...
    'resources/assets/js/vue.js', // Asset-IT's initializer for Vue.js
    './public/js/build'
).sourceMaps()
.scripts([
    ...
    './resources/assets/js/Assetit.js', //this is the actual Asset-IT JS
    './resources/assets/js/Assetit_modals.js'
],
