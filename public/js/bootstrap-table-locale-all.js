 ...
 * Author: Phillip Kruger <phillip.kruger@>
 */
(function ($) {
    'use strict';
 ...
 * Authors: Marc Pina<iwalkalone69@>
 *          Claudi Martinez<claudix.kernel@>
 */
(function ($) {
    'use strict';
 ...
 * Author: Jakub Svestka <svestka1999@>
 */
(function ($) {
    'use strict';
 ...
 * Author: Felix Vera (felix.vera@) 
 * Copiado: Mauricio Vera (mauricioa.vera@)
 */
(function ($) {
    'use strict';
 ...
 * Author: Julien Bisconti (julien.bisconti@)
 */
(function ($) {
    'use strict';
 ...
 * Author: Petra Štrbenac (petra.strbenac@)
 * Author: Petra Štrbenac (petra.strbenac@)
 */
(function ($) {
    'use strict';
 ...
 * Author: Davide Renzi<davide.renzi@>
 * Author: Davide Borsatto <davide.borsatto@>
 */
(function ($) {
    'use strict';
 ...
 * Author: Azamshul Azizy <azamshul@>
 */
(function ($) {
    'use strict';
 ...
 * Author: Levan Lotuashvili <l.lotuashvili@>
 */
(function ($) {
    'use strict';
 ...
 * Author: Yi Tae-Hyeong (jsonobject@)
 */
(function ($) {
    'use strict';
 ...
 * Author: Eduardo Cerqueira<egcerqueira@>
