 ...
 * @param  {JSON} settings Insulated `window.Assetit.settings` object.
...
}(jQuery, window.Assetit.settings));
...
$(document).ready(function () {
    ...
    */
    ...
    // So a URL such as, http://Asset-it.local/hardware/2/#my_tab will
...
/* 
 * 
 * Asset-IT Universal Modal support
 * 
 * Enables modal dialogs to create sub-resources throughout Asset-IT
 * 
 */
...
$(function () {
  ...
  $('#createModal').on("show.bs.modal", function (event) {
      ...
      $('#createModal').load(link.attr('href'),function () {
        ...
        // This is a copy/paste of the code from Assetit.js, would be great to only have this in one place.
        $('.js-data-ajax').each( function (i,item) {
            var link = $(item);
            var endpoint = link.data("endpoint");
            var select = link.data("select");
