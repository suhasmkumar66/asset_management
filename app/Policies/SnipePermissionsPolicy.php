...
/**
 * AssetPermissionsPolicy provides methods for handling the granular permissions used throughout Asset-IT.
...
abstract class AssetPermissionsPolicy
{
    /**
    ...
    public function before(User $user, $ability, $item)
    {
        ...
        if ($item instanceof \App\Models\AssetModel && !Company::isCurrentUserHasAccess($item)) {
            return false;
        }
