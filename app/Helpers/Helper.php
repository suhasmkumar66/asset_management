...
class Helper
{
    ...
    public static function ticketcategoryTypeList()
    {
        $category_types = array(
            '' => '',
            'Desktop' => 'Desktop',
            ...
            'Telephone' => 'Telephone',
            'CCTV' => 'CCTV',
            'Token Calling System' => 'Token Calling System',
            'Biometric' => 'Biometric',
            'Event Support' => 'Event Support',
            'Console Machine' => 'Console Machine',
            'HIMS' => 'HIMS'
//             'Others' => 'Others'
        );
        return $category_types;
    ...
    public static function priorityTypeList()
    {
    ...
    public static function buildingTypeList()
    {
        $building = array(
           '' => '',
            'RC Block' => 'RC Block',
    ...
    public static function floorTypeList(){
        $floor = array(
            '' => '',
            'Basement' => 'Basement',
    ...
    public static function ticketStatusTypeList(){
        $status = array(
            '' => '',
            'open' => 'open',
    ...
    public static function wingTypeList(){
        $wing = array(
            '' => '',
            'Center' => 'Center',
            'East-1' => 'East-1',
