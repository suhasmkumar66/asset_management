 ...
 * the Asset-IT Asset Management application.
 *
 * @version    v1.0
...
class AssetsController extends Controller
{
    ...
    public function store(AssetRequest $request)
    {
        ...
        $asset->room_name               = $request->input('room_name');
        $asset->hod_name                = $request->input('hod_name');
        $asset->end_username            = $request->input('end_username');
        $asset->processor_type          = $request->input('processor_type');
        $asset->processor_speed         = $request->input('processor_speed');
        $asset->ram_type                = $request->input('ram_type');
        $asset->ram_1gb                 = $request->input('ram_1gb');
        $asset->ram_2gb                 = $request->input('ram_2gb');
        $asset->ram_3gb                 = $request->input('ram_3gb');
        $asset->hdd_type                = $request->input('hdd_type');
        $asset->hdd_1gb                 = $request->input('hdd_1gb');
        $asset->dvd                     = $request->input('dvd');
        $asset->os                      = $request->input('os');
        $asset->os_bit                  = $request->input('os_bit');
        $asset->ms_office               = $request->input('ms_office');
        $asset->antivirus               = $request->input('antivirus');
        $asset->av_status               = $request->input('av_status');
