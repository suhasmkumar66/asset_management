...
class LoginController extends Controller
{
    ...
    public function getTwoFactorEnroll()
    {
        ...
        $barcode_obj =  $barcode->getBarcodeObj('QRCODE', 'otpauth://totp/'.urlencode($settings->site_name).':'.urlencode($user->username).'?secret='.urlencode($secret).'&issuer=Asset-IT&period=30', 300, 300, 'black', array(-2, -2, -2, -2));
