...
Route::group(['middleware' => 'auth'], function () {
    ...
    */
    ...
    Route::group([ 'prefix' => 'tickets','middleware' => ['auth'] ], function () {
        ...
        Route::get(
            '{ticket_id}/assign',
            [ 'as' => 'tickets.assign.save', 'uses' => 'TicketsController@getassign' ]
            );
        Route::post(
            '{ticket_id}/assign',
            [ 'as' => 'tickets.assign.post', 'uses' => 'TicketsController@postassign' ]
            );
        
        //Logs
        Route::get(
            '{ticket_id}/logs',
            [ 'as' => 'tickets.logs.save', 'uses' => 'TicketsController@getLogs' ]
            );
        //Reject
        Route::get(
            '{ticket_id}/reject',
            [ 'as' => 'tickets.reject.save', 'uses' => 'TicketsController@getReject' ]
            );
        Route::post(
            '{ticket_id}/reject',
            [ 'as' => 'tickets.reject.post', 'uses' => 'TicketsController@postReject' ]
            );
        // close
        Route::get(
            '{ticket_id}/close',
            [ 'as' => 'tickets.close.save', 'uses' => 'TicketsController@getClose' ]
            );
        Route::post(
            '{ticket_id}/close',
            [ 'as' => 'tickets.close.post', 'uses' => 'TicketsController@postClose' ]
            );
        // Ack
        Route::get(
            '{ticket_id}/acknowledge',
            [ 'as' => 'tickets.ack.save', 'uses' => 'TicketsController@getAck' ]
            );
        Route::post(
            '{ticket_id}/acknowledge',
            [ 'as' => 'tickets.ack.post', 'uses' => 'TicketsController@postAck' ]
            );
        // Transfer
        Route::get(
            '{ticket_id}/transfer',
            [ 'as' => 'tickets.transfer.save', 'uses' => 'TicketsController@getTransfer' ]
            );
        Route::post(
            '{ticket_id}/transfer',
            [ 'as' => 'tickets.transfer.post', 'uses' => 'TicketsController@postTransfer' ]
            );
        // Accept
        Route::get(
            '{ticket_id}/accept',
            [ 'as' => 'tickets.accept.save', 'uses' => 'TicketsController@getAccept' ]
            );
        Route::post(
            '{ticket_id}/accept',
            [ 'as' => 'tickets.accept.post', 'uses' => 'TicketsController@postAccept' ]
            );
        Route::get(
            'index',
            [ 'as' => 'tickets.accept.save', 'uses' => 'TicketsController@index' ]
            );
        Route::get(
            'open',
            [ 'as' => 'tickets.accept.save', 'uses' => 'TicketsController@index' ]
    ...
    Route::resource('ticketreports','TicketsReportController',[
        'parameters' => ['ticketreports' => 'ticket_id']
    ]);
...
//     Route::get('create-tickets', [ 'as' => 'create-tickets', 'uses' => 'TicketsController@getIndex' ]);
//     Route::get('view-tickets', [ 'as' => 'view-tickets', 'uses' => 'TicketsController@viewTickets' ]);
