...
Route::group(['prefix' => 'v1','namespace' => 'Api', 'middleware' => 'api'], function () {
    ...
    Route::get( 'ticketreports',  [
        'as' => 'api.ticketreports.index',
        'uses' => 'TicketsReportController@index'
    ]);
    
    Route::post( 'ticketreports/filter',  [
        'as' => 'api.ticketreports.postFiltering',
        'uses' => 'TicketsReportController@postFiltering'
    ]);
