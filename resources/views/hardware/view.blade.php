  ...
  <div class="col-md-12">
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        ...
        <li>
          <a href="#history" data-toggle="tab"><span class="hidden-lg hidden-md"><i class="fa fa-history"></i></span> <span class="hidden-xs hidden-sm">Logs</span></a>
        </li>
        ...
        <div class="tab-pane fade in active" id="details">
          <div class="row">
             <div class="col-md-4 mobile">
              ...
              @if  ($SuhasSettings->qr_code=='1')
                 <img src="{{ config('app.url') }}/hardware/{{ $asset->id }}/qr_code" class="img-thumbnai" style="height: 100px; width: 100px; margin-right: 10px;">
              @endif
              ...
              <div class="table-responsive" style="margin-top: 10px;">
                <table class="table">
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          @elseif (($asset->id) && ($asset->location))
                            {{ $asset->location->currency }}
                          @else
                            {{ $SuhasSettings->default_currency }}
                          @endif
					...
					@if($asset->processor_type != '')
                    <tr>
                      <td>Processor Type</td>
                      <td>
                        {{ ($asset->processor_type) }}
                      </td>
                    </tr>
					@endif
					
					@if($asset->processor_speed != '')
                    <tr>
                      <td>Processor Speed</td>
                      <td>
                        {{ ($asset->processor_speed) }}
                      </td>
                    </tr>
					@endif
        ...
        <div class="tab-pane fade" id="history">
          ...
          <div class="row">
           ...
           <!--   <th data-field="icon" data-visible="true" style="width: 40px;" class="hidden-xs" data-formatter="iconFormatter"></th>-->    
                  <th class="col-sm-2" data-visible="true" data-field="item" data-formatter="polymorphicItemFormatter">Asset Name</th>
                  <th class="col-sm-1" data-visible="true" data-field="action_type">{{ trans('general.action') }}</th>
                  <th class="col-sm-2" data-visible="true" data-field="target" data-formatter="polymorphicItemFormatter">User</th>
                  ...
                  <th class="col-sm-1" data-visible="true" data-field="admin" data-formatter="usersLinkObjFormatter">Created By</th>
                  @if  ($SuhasSettings->require_accept_signature=='1')
