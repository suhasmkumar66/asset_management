...
@section('inputFields')
  ...
  <div class="form-group {{ $errors->has('floor') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7 col-sm-12{{  (\App\Helpers\Helper::checkIfRequired($item, 'floor')) ? ' required' : '' }}">
        <input class="form-control" type="text" name="floor" id="floor" value="{{ Input::old('floor', $item->floor) }}" />
 ...
 <div class="form-group {{ $errors->has('room_name') ? ' has-error' : '' }}">
    <label for="room_name" class="col-md-3 control-label">Room Name</label>
    <div class="col-md-7 col-sm-12{{  (\App\Helpers\Helper::checkIfRequired($item, 'room_name')) ? ' required' : '' }}">
        <input class="form-control" type="text" name="room_name" id="room_name" value="{{ Input::old('room_name', $item->room_name) }}" />
        {!! $errors->first('room_name', '<span class="alert-msg"><i class="fa fa-times"></i> :message</span>') !!}
    </div>
</div>

 <div class="form-group {{ $errors->has('hod_name') ? ' has-error' : '' }}">
    <label for="hod_name" class="col-md-3 control-label">HOD Name</label>
    <div class="col-md-7 col-sm-12{{  (\App\Helpers\Helper::checkIfRequired($item, 'hod_name')) ? ' required' : '' }}">
        <input class="form-control" type="text" name="hod_name" id="hod_name" value="{{ Input::old('hod_name', $item->hod_name) }}" />
        {!! $errors->first('hod_name', '<span class="alert-msg"><i class="fa fa-times"></i> :message</span>') !!}
    </div>
</div>

<div class="form-group {{ $errors->has('end_username') ? ' has-error' : '' }}">
    <label for="end_username" class="col-md-3 control-label">User Name</label>
    <div class="col-md-7 col-sm-12{{  (\App\Helpers\Helper::checkIfRequired($item, 'end_username')) ? ' required' : '' }}">
        <input class="form-control" type="text" name="end_username" id="end_username" value="{{ Input::old('end_username', $item->end_username) }}" />
        {!! $errors->first('end_username', '<span class="alert-msg"><i class="fa fa-times"></i> :message</span>') !!}
    </div>
</div>

<div class="form-group">
    <label for="processor_type" class="col-md-3 control-label">Processor Type</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="processor_type" id="processor_type" value="{{ Input::old('processor_type', $item->processor_type) }}" />
    </div>
</div>

<div class="form-group">
    <label for="processor_speed" class="col-md-3 control-label">Processor Speed</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="processor_speed" id="processor_speed" value="{{ Input::old('processor_speed', $item->processor_speed) }}" />
    </div>
</div>

<div class="form-group">
    <label for="ram_type" class="col-md-3 control-label">RAM Type</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="ram_type" id="ram_type" value="{{ Input::old('ram_type', $item->ram_type) }}" />
    </div>
</div>

<div class="form-group">
    <label for="ram_1gb" class="col-md-3 control-label">RAM 1GB</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="ram_1gb" id="ram_1gb" value="{{ Input::old('ram_1gb', $item->ram_1gb) }}" />
    </div>
</div>

<div class="form-group">
    <label for="ram_2gb" class="col-md-3 control-label">RAM 2GB</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="ram_2gb" id="ram_2gb" value="{{ Input::old('ram_2gb', $item->ram_2gb) }}" />
    </div>
</div>

<div class="form-group">
    <label for="ram_3gb" class="col-md-3 control-label">RAM 3GB</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="ram_3gb" id="ram_3gb" value="{{ Input::old('ram_3gb', $item->ram_3gb) }}" />
    </div>
</div>

<div class="form-group">
    <label for="hdd_type" class="col-md-3 control-label">HDD Type</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="hdd_type" id="hdd_type" value="{{ Input::old('hdd_type', $item->hdd_type) }}" />
    </div>
</div>

<div class="form-group">
    <label for="hdd_1gb" class="col-md-3 control-label">HDD 1GB</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="hdd_1gb" id="hdd_1gb" value="{{ Input::old('hdd_1gb', $item->hdd_1gb) }}" />
    </div>
</div>

<div class="form-group">
    <label for="dvd" class="col-md-3 control-label">DVD</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="dvd" id="dvd" value="{{ Input::old('dvd', $item->dvd) }}" />
    </div>
</div>

<div class="form-group">
    <label for="os" class="col-md-3 control-label">OS</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="os" id="os" value="{{ Input::old('os', $item->os) }}" />
    </div>
</div>

<div class="form-group">
    <label for="os_bit" class="col-md-3 control-label">OS BIT</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="os_bit" id="os_bit" value="{{ Input::old('os_bit', $item->os_bit) }}" />
    </div>
</div>

<div class="form-group">
    <label for="ms_office" class="col-md-3 control-label">MS Office</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="ms_office" id="ms_office" value="{{ Input::old('ms_office', $item->ms_office) }}" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="antivirus" id="antivirus" value="{{ Input::old('antivirus', $item->antivirus) }}" />
    </div>
</div>

<div class="form-group">
    <label for="av_status" class="col-md-3 control-label">AV Status</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="av_status" id="av_status" value="{{ Input::old('av_status', $item->av_status) }}" />
    </div>
</div>

<div class="form-group">
    <label for="serial" class="col-md-3 control-label">MAC Address</label>
    <div class="col-md-7 col-sm-12">
        <input class="form-control" type="text" name="mac_address" id="mac_address" value="{{ Input::old('mac_address', $item->mac_address) }}" />
    </div>
</div>
