                    ...
                    @if ($user->activated=='1')
                      ...
                      <tr>
                        ...
                        <td class="two_factor_resetrow">
                          ...
                          @if ((Auth::user()->isSuperUser()) && ($SuhasSettings->two_factor_enabled!='0'))
                            <div class="col-md-11">
          ...
          <div class="table-responsive">
            ...
            <table
              ...
              <tr>
                ...
                <th class="col-sm-2" data-field="admin" data-formatter="usersLinkObjFormatter">Created By</th>
                <th class="col-sm-2" data-field="action_type">{{ trans('general.action') }}</th>
                <th class="col-sm-3" data-field="item" data-formatter="polymorphicItemFormatter">{{ trans('general.item') }}</th>
                <th class="col-sm-2" data-field="target" data-formatter="polymorphicItemFormatter">User</th>
              </tr>
              </thead>
            </table>
