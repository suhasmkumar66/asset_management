                            ...
                            @if (($SuhasSettings->show_images_in_email=='1' ) && ($SuhasSettings::setupCompleted()))
                                ...
                                @if ($SuhasSettings->brand == '3')
                                    @if ($SuhasSettings->logo!='')
                                        <img class="navbar-brand-img logo" style="max-width: 50px;" src="{{ url('/') }}/uploads/{{ $SuhasSettings->logo }}">
                                    @endif
                            ...
                            <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        <!-- Salutation -->
                                        <p style="{{ $style['paragraph'] }}">
                                            Regards,<br>{{ $SuhasSettings->site_name }}
                                        </p>
                            ...
                            <table style="{{ $style['email-footer'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                        <p style="{{ $style['paragraph-sub'] }}">
                                            &copy; {{ date('Y') }}
                                            <a style="{{ $style['anchor'] }}" href="{{ url('/') }}" target="_blank">{{ $SuhasSettings->site_name }}</a>.
                                            All rights reserved.
                                        </p>
