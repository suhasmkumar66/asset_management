                   ...
                   <div class="form-group {{ $errors->has('default_eula_text') ? 'error' : '' }}">
                    ...
                    <div class="form-group {{ $errors->has('login_note') ? 'error' : '' }}">
                       ...
                       <div class="form-group {{ $errors->has('show_in_model_list') ? 'error' : '' }}">
                           ...
                           <div class="col-md-9">
                               {{ Form::checkbox('show_in_model_list[]', 'image', Input::old('show_in_model_list', $SuhasSettings->modellistCheckedValue('image')),array('class' => 'minimal')) }} {{ trans('general.image') }} <br>
                               {{ Form::checkbox('show_in_model_list[]', 'category', Input::old('show_in_model_list', $SuhasSettings->modellistCheckedValue('category')),array('class' => 'minimal')) }} {{ trans('general.category') }} <br>
                               {{ Form::checkbox('show_in_model_list[]', 'manufacturer', Input::old('show_in_model_list', $SuhasSettings->modellistCheckedValue('manufacturer')),array('class' => 'minimal')) }}  {{ trans('general.manufacturer') }} <br>
                               {{ Form::checkbox('show_in_model_list[]', 'model_number', Input::old('show_in_model_list', $SuhasSettings->modellistCheckedValue('model_number')),array('class' => 'minimal')) }} {{ trans('general.model_no') }}<br>
                           </div>
                       </div>
                       <!-- /.form-group -->
