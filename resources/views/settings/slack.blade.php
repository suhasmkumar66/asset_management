                ...
                <div class="box-body">
                    ...
                    <div class="col-md-11 col-md-offset-1" style="border-top: 0px;">
                        ...
                        <div class="form-group {{ $errors->has('slack_botname') ? 'error' : '' }}">
                            ...
                            <div class="col-md-9">
                                @if (config('app.lock_passwords')===true)
                                    {{ Form::text('slack_botname', Input::old('slack_botname', $setting->slack_botname), array('class' => 'form-control','disabled'=>'disabled','placeholder' => 'Suhas-Bot')) }}
                                @else
                                    {{ Form::text('slack_botname', Input::old('slack_botname', $setting->slack_botname), array('class' => 'form-control','placeholder' => 'Suhas-Bot')) }}
                                @endif
