                    ...
                    <div class="box login-box">
                        ...
                        <div class="login-box-body">
                            <div class="row">
                                ...
                                @if ($SuhasSettings->login_note)
                                    <div class="col-md-12">
                                        <div class="alert alert-info">
                                            {!!  Parsedown::instance()->text(e($SuhasSettings->login_note))  !!}
                                        </div>
                                    </div>
                                @endif
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 text-right" style="padding-top: 10px;">
                            @if ($SuhasSettings->custom_forgot_pass_url)
                                <a href="{{ $SuhasSettings->custom_forgot_pass_url  }}" rel="noopener">{{ trans('auth/general.forgot_password')  }}</a>
                            @else
