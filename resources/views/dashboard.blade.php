...
@if ($SuhasSettings->dashboard_message!='')
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        {!!  Parsedown::instance()->text(e($SuhasSettings->dashboard_message))  !!}
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
  ...
  <div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-red">
      ...
      @can('index', \App\Models\Ticket::class)
        <a href="{{ route('tickets.index') }}/index" class="small-box-footer">{{ trans('general.moreinfo') }} <i class="fa fa-arrow-circle-right"></i></a>
      @endcan
    </div>
  </div><!-- ./col -->
  ...
  <div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-blue">
      <div class="inner">
        <h3> {{ number_format($counts['open_ticket']) }}</h3>
          <p>open tickets</p>
      </div>
      <div class="icon">
      ...
      @can('index', \App\Models\Ticket::class)
        <a href="{{ route('tickets.index') }}/open" class="small-box-footer">{{ trans('general.moreinfo') }} <i class="fa fa-arrow-circle-right"></i></a>
      @endcan
    </div>
  </div><!-- ./col -->
   ...
   <div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-info">
      <div class="inner">
        <h3> {{ number_format($counts['assigned_ticket']) }}</h3>
      ...
      @can('index', \App\Models\Ticket::class)
        <a href="{{ route('tickets.index') }}/assigned" class="small-box-footer">{{ trans('general.moreinfo') }} <i class="fa fa-arrow-circle-right"></i></a>
      @endcan
    </div>
  </div><!-- ./col -->
  ...
  <div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-yellow">
      <div class="inner">
        <h3> {{ number_format($counts['inprogress_ticket']) }}</h3>
      ...
      @can('index', \App\Models\Ticket::class)
        <a href="{{ route('tickets.index') }}/inprogress" class="small-box-footer">{{ trans('general.moreinfo') }} <i class="fa fa-arrow-circle-right"></i></a>
      @endcan
    </div>
  </div><!-- ./col -->
    ...
    <div class="small-box bg-success">
      <div class="inner">
        <h3> {{ number_format($counts['closed_ticket']) }}</h3>
          <p>closed tickets</p>
      </div>
      <div class="icon">
      ...
      @can('index', \App\Models\Ticket::class)
        <a href="{{ route('tickets.index') }}/closed" class="small-box-footer">{{ trans('general.moreinfo') }} <i class="fa fa-arrow-circle-right"></i></a>
      @endcan
    </div>
  </div><!-- ./col -->
  ...
  <div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-green">
      <div class="inner">
        <h3> {{ number_format($counts['ack_ticket']) }}</h3>
          <p>acknowledged tickets</p>
      </div>
      <div class="icon">
        <i class="fa fa-check"></i>
      </div>
      @can('index', \App\Models\Ticket::class)
        <a href="{{ route('tickets.index') }}/acknowledged" class="small-box-footer">{{ trans('general.moreinfo') }} <i class="fa fa-arrow-circle-right"></i></a>
      @endcan
    </div>
  </div><!-- ./col -->
</div>
...
@if ($SuhasSettings->load_remote=='1')
