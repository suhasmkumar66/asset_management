...
<html>
  <head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
      ...
      <link rel="apple-touch-icon" href="{{ url('/') }}/uploads/{{ $SuhasSettings->logo }}">
      <link rel="apple-touch-startup-image" href="{{ url('/') }}/uploads/{{ $SuhasSettings->logo }}">
    ...
    <script nonce="{{ csrf_token() }}">
      ...
      @if (($SuhasSettings) && ($SuhasSettings->skin!=''))
          <link rel="stylesheet" href="{{ url('css/skins/skin-'.$SuhasSettings->skin) }}.css">
      @endif
    ...
    <script nonce="{{ csrf_token() }}">
          window.Suhasit = {
              settings: {
                  "per_page": {{ $SuhasSettings->per_page }}
              }
          };
    </script>
  ...
  <body class="sidebar-mini skin-blue {{ (session('menu_state')!='open') ? 'sidebar-mini sidebar-collapse' : ''  }}">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
			<img class="img-padding" src="{{ url('/') }}/uploads/{{ $SuhasSettings->logo }}">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <ul class="nav navbar-nav navbar-left">
              <li class="left-navblock w-100">
                 @if ($SuhasSettings->brand == '3')
                      <a class="logo navbar-brand no-hover" href="{{ url('/') }}">
                          @if ($SuhasSettings->logo!='')
                          <img class="navbar-brand-img" src="{{ url('/') }}/uploads/{{ $SuhasSettings->logo }}">
                          @endif
                          {{ $SuhasSettings->site_name }}
                      </a>
          ...
          <!-- Navbar Right Menu -->
            <div class="navbar-custom-menu float-none">
              <ul class="nav navbar-nav float-none icon-list">
                  ...
                  @can('index', \App\Models\Asset::class)
                  <form class="navbar-form navbar-left form-horizontal remove-borders" role="search" action="{{ route('findbytag/hardware') }}" method="get">
                  ...
                  <li class="dropdown">
                   ...
                   <ul class="dropdown-menu right-56">
               ...
               @can('admin')
               @if ($SuhasSettings->show_alerts_in_menu=='1')
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li {!! (Request::is('fields*') ? ' class="active"' : '') !!}>
                      <a href="{{ route('tickets.index') }}/index">
            ...
            <li class="treeview{{ (Request::is('reports*') ? ' active' : '') }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
					 ...
					 <li>
                        <a href="{{ url('ticketreports') }}?company=%?user=%?type=%?from=%?to=%" {{ (Request::is('ticketreports') ? ' class="active"' : '') }}>
                            Ticket Report
                        </a>
                    </li>
                </ul>
      ...
      <footer class="main-footer hidden-print">
        ...
        <a target="_blank" href="https://dalvkot.com" rel="noopener">Dalvkot-IT</a>
      </footer>
