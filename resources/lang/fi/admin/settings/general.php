...
return array(
  ...
  'default_language'			=> 'Oletuskieli',
    ...
    'load_remote_help_text'		=> 'Tämä Asset-IT-asennus voi ladata skriptejä ulkopuolelta.',
    ...
    'show_images_in_email_help'   => 'Poista tämä valinta, jos Asset-IT asennus on toteutettu VPN: n avulla tai suljetussa verkossa, koska sähköposteissa käytetyt kuvat eivät voi latautua näkyviin sähköposteissa.',
    ...
    'Suhas_version'  			=> 'Asset-IT versio',
    'support_footer'            => 'Tuki-alatunnisteen linkit ',
    'support_footer_help'       => 'Määrittele, kuka voi nähdä linkit Asset-IT tukipalvelun tietoihin ja käyttöohjeeseen',
    'version_footer'            => 'Versio alatunnisteessa ',
    'version_footer_help'       => 'Määrittele, kuka näkee Asset-IT järjestelmän version ja käännöksen numeron.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Linkki Asset-IT: hen sähköposteissa',
    'show_url_in_emails_help_text'      => 'Poista tämä valintaruutu, jos et halua linkata takaisin Asset-IT-asennukseen sähköpostin alatunnisteisiin. Hyödyllinen, jos useimmat käyttäjät eivät koskaan kirjaudu sisään.',
    'text_pt'        => 'pt',
