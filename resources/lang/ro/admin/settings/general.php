...
return array(
  ...
  'default_language'			=> 'Limba implicita',
    ...
    'load_remote_help_text'		=> 'Această instalare Asset-IT poate încărca scripturi din lumea exterioară.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Dacă este furnizată aici o adresă URL, utilizatorii vor fi redirecționați către această adresă URL după ce utilizatorul va ieși din Asset-IT. Acest lucru este util pentru a închide corect sesiunile de utilizator ale furnizorului dvs. de autentificare.',
    'logo'                    	=> 'Siglă',
    ...
    'show_images_in_email_help'   => 'Debifați această casetă dacă instalarea dvs. Asset-IT se află în spatele unei rețele VPN sau închisă, iar utilizatorii din afara rețelei nu vor putea încărca imagini din această instalare în e-mailurile lor.',
    'site_name'                 => 'Nume site',
    ...
    'Suhas_version'  			=> 'Asset-IT versiune',
    'support_footer'            => 'Legăturile de suport in subsol ',
    'support_footer_help'       => 'Specificați cine vede legăturile la informațiile despre asistența Asset-IT și la Manualul utilizatorilor',
    'version_footer'            => 'Versiune în subsol ',
    'version_footer_help'       => 'Specificați cine vede versiunea Asset-IT și numărul de construcție.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link către Asset-IT în e-mailuri',
    'show_url_in_emails_help_text'      => 'Debifați această casetă dacă nu doriți să vă conectați la instalarea dvs. Asset-IT în subsolul dvs. de e-mail. Utile dacă majoritatea utilizatorilor dvs. nu se înregistrează niciodată.',
    'text_pt'        => 'pt',
