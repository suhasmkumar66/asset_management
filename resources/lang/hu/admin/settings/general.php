...
return array(
  ...
  'default_language'			=> 'Alapértelmezett nyelv',
    ...
    'load_remote_help_text'		=> 'Ez a Asset-IT telepítés betölti a szkripteket a külvilágtól.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ha megad itt egy URL-t, a felhasználók a Asset-IT-ből való kilépéskor át lesznek irányítva a megadott URL-re. Ez hasznos lehet a hitelesítés szolgáltatónál meglévő felhasználói munkamenet megfelelő lezárására.',
    'logo'                    	=> 'logo',
    ...
    'show_images_in_email_help'   => 'Vegye ki a jelölést innen, ha az Ön Asset-IT alkalmazása VPN mögött, vagy zárt hálózaton található, és a felhasználók a hálózaton kívül nem tudják az emailekben megjeleníteni az alkalmazás által szolgáltatott képeket.',
    ...
    'Suhas_version'  			=> 'Asset-IT változat',
    'support_footer'            => 'Lábjegyzet linkek támogatása ',
    'support_footer_help'       => 'Adja meg, hogy ki láthassa a Asset-IT támogatási információ és a felhasználói kézikönyv linkjeit',
    'version_footer'            => 'Verzió a láblécben ',
    'version_footer_help'       => 'Határozza meg, hogy ki láthassa a Asset-IT verzió és build adatokat.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link a Asset-IT-re az e-mailekben',
    'show_url_in_emails_help_text'      => 'Törölje a jelet a jelölőnégyzetből, ha nem kíván visszaváltani a Asset-IT telepítéséhez az e-mail láblécében. Hasznos ha a legtöbb felhasználó soha nem jelentkezik be.',
    'text_pt'        => 'pt',
