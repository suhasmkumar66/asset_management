...
return array(
  ...
  'default_language'			=> 'Язык по умолчанию',
    ...
    'load_remote_help_text'		=> 'Данная установка Asset-IT может загружать внешние скрипты.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Если здесь будет указан URL-адрес, пользователи будут перенаправлены туда после выхода из Asset-IT. Это полезно для правильного закрытия пользовательской сессии вашего поставщика аутентификации.',
    'logo'                    	=> 'Логотип',
    ...
    'show_images_in_email_help'   => 'Снимите этот флажок, если ваша установка Asset-IT находится за VPN или в закрытой сети в случае, если в E-mail-ах, которые просматриваются пользователями за пределами указанной сети не отбражаются/не загружаются изображения из данной установки Asset-IT.',
    ...
    'Suhas_version'  			=> 'Версия Asset-IT',
    'support_footer'            => 'Ссылки на поддержу в нижнем колонтитуле ',
    'support_footer_help'       => 'Отображать или не отображать ссылку на руководство пользователя и поддержку Asset-IT',
    'version_footer'            => 'Версия в нижнем колонтитуле ',
    'version_footer_help'       => 'Отображать или не отображать версию и номер сборки Asset-IT.',
    ...
    'width_w'        => 'ширина',
    'height_h'        => 'высота',
    'show_url_in_emails'                => 'Ссылка на Asset-IT в электронных письмах',
    'show_url_in_emails_help_text'      => 'Снимите этот флажок, если вы не хотите ссылаться на свою установку Asset-IT в нижних колонтитулах электронной почты. Полезно, если большинство ваших пользователей никогда не заходят в систему.',
    'text_pt'        => 'pt',
