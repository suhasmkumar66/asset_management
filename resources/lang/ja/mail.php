...
return array(
    ...
    'login_first_admin' => '以下の新しいログイン情報を使用して、Asset-ITにログインします。',
    'login' => 'ログイン:',
    ...
    'supplier' => '仕入先',
    'tag' => 'タグ',
    'test_email' => 'Asset-ITからのテストメール',
    'test_mail_text' => 'これはAsset-IT資産管理システムのテストです。あなたがこれを読めているなら、メール機能は動作しています:)',
    ...
    'your_credentials' => 'Asset-IT クレデンシャル',
);
