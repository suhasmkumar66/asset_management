...
return array(
  ...
  'default_language'			=> '既定の言語',
    ...
    'load_remote_help_text'		=> 'Asset-ITのインストールは、外部からスクリプトを読み込むことが可能です。',
...
これは認証プロバイダのセッションを正しく終了させる場合に便利です。',
    ...
    'show_images_in_email_help'   => 'Asset-ITが閉鎖されたネットワーク内にある場合や、アクセスするためにVPNの利用が必要な場合はこのボックスのチェックを外してください。ネットワーク外のユーザは、配信されたメールにある画像を読み込むことはできません。',
    'site_name'                 => 'サイト名',
    ...
    'Suhas_version'  			=> 'Asset-IT バージョン',
    'support_footer'            => 'フッターのリンクをサポートします。 ',
    'support_footer_help'       => 'Asset-ITサポート情報とユーザーマニュアルへのリンクを確認する',
    'version_footer'            => 'フッターにバージョン情報を表示 ',
    'version_footer_help'       => 'Asset-ITのバージョンとビルド番号を表示するか、管理者のみに表示させるかを設定できます。',
    'system'                    => 'システム情報',
    'update'                    => '設定を更新',
    'value'                     => '価値',
    'brand'                     => 'ブランディング',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Asset-ITへのリンク',
    'show_url_in_emails_help_text'      => '電子メールのフッターでAsset-ITのインストールにリンクしたくない場合は、このボックスのチェックを外してください。ほとんどのユーザーが決してログインしない場合に便利です。',
    'text_pt'        => 'pt',
