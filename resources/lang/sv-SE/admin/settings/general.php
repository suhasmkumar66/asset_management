...
return array(
  ...
  'default_language'			=> 'Standardspråk',
    ...
    'load_remote_help_text'		=> 'Denna Asset-IT-installation kan ladda skript från omvärlden.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Om en URL tillhandahålls här kommer användarna att omdirigeras till den här webbadressen efter att användaren loggat ut från Asset-IT. Det här är användbart för att stänga användarsessionerna i din autentiseringsleverantör korrekt.',
    'logo'                    	=> 'Logotyp',
    ...
    'show_images_in_email_help'   => 'Avmarkera den här rutan om din Asset-IT-installation ligger bakom ett VPN eller ett stängt nätverk och användare utanför nätverket kan inte ladda bilder som visas från den här installationen i sina e-postmeddelanden.',
    'site_name'                 => 'Sidnamn',
    ...
    'Suhas_version'  			=> 'Asset-IT-versionen',
    'support_footer'            => 'Stöd länkar i sidfot ',
    'support_footer_help'       => 'Ange vem som kan se länkarna till Asset-IT Support info och användarmanual',
    'version_footer'            => 'Version i sidfot ',
    'version_footer_help'       => 'Specificera vilka som kan se Asset-IT version och build nummer.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Länk till Asset-IT i e-post',
    'show_url_in_emails_help_text'      => 'Avmarkera den här rutan om du inte vill länka tillbaka till din Asset-IT-installation i dina e-postfoton. Användbart om de flesta av dina användare aldrig loggar in.',
    'text_pt'        => 'pt',
