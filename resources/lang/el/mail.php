...
return array(
    ...
    'login_first_admin' => 'Συνδεθείτε στη νέα σας εγκατάσταση Asset-IT χρησιμοποιώντας τα παρακάτω διαπιστευτήρια:',
    'login' => 'Σύνδεση:',
    ...
    'tag' => 'Ετικέτα',
    'test_email' => 'Έλεγχος email για Asset-IT',
    'test_mail_text' => 'Πρόκειται για μια δοκιμή από το σύστημα διαχείρισης περιουσιακών στοιχείων της Asset-IT. Αν το έχετε, το mail λειτουργεί :)',
    ...
    'your_credentials' => 'Τα διαπιστευτήρια σας Asset-IT',
);
