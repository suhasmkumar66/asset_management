...
return array(
  ...
  'default_language'			=> 'Numatyta kalba',
    ...
    'load_remote_help_text'		=> 'Šis Asset-IT įdiegimas gali įtraukti programinius kodus iš interneto.',
    ...
    'show_images_in_email_help'   => 'Nuimkite žymelę jeigu jūsų Asset-IT instaliacija yra VPN arba uždarame tinkle ir vartotojai esantys už tinklo negalės įkrauti paveikslėlių jų el. paštuose.',
    ...
    'support_footer_help'       => 'Nurodykite, kas matys nuorodas į „Asset-IT“ palaikymo informacijos ir naudotojo vadovą',
    'version_footer'            => 'Versija poraštėje ',
    'version_footer_help'       => 'Nurodykite kad galės matyti Asset-IT versijas ir versijos numerius.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Nuoroda į "Asset-IT" el. Paštu',
    'show_url_in_emails_help_text'      => 'Atžymėkite šį langelį, jei nenorite susieti savo "Asset-IT" diegimo savo el. Pašto dėžutėse. Naudinga, jei dauguma jūsų naudotojų niekada nebus prisijungę.',
    'text_pt'        => 'pt',
