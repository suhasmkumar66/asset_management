...
return array(
  ...
  'default_language'			=> 'Standaardtaal',
    ...
    'load_remote_help_text'		=> 'Deze Asset-IT installatie kan scripts van de buitenwereld laden.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Als hier een URL wordt opgegeven, worden gebruikers doorgestuurd naar deze URL nadat de gebruiker zich heeft afgemeld bij Asset-IT. Dit is handig om de gebruikerssessies van uw authenticatieprovider correct te sluiten.',
    'logo'                    	=> 'Logo',
    ...
    'show_images_in_email_help'   => 'Schakel dit selectievakje uit als uw Asset-IT-installatie zich achter een VPN of gesloten netwerk bevindt en gebruikers buiten het netwerk geen afbeeldingen vanuit Asset-IT in hun e-mails kunnen laten zien.',
    'site_name'                 => 'Site naam',
    ...
    'Suhas_version'  			=> 'Asset-IT Versie',
    'support_footer'            => 'Ondersteuningsvoettekst links ',
    'support_footer_help'       => 'Geef aan wie de links naar de Asset-IT-ondersteuningsinformatie en gebruikershandleiding ziet',
    'version_footer'            => 'Versie in voettekst ',
    'version_footer_help'       => 'Geef aan wie de Asset-IT-versie en het buildnummer ziet.',
    ...
    'width_w'        => 'b',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link naar Asset-IT in e-mails',
    'show_url_in_emails_help_text'      => 'Schakel dit selectievakje uit als u niet wilt koppelen aan uw Asset-IT-installatie in uw e-mailberichten. Nuttig als de meeste gebruikers nooit inloggen.',
    'text_pt'        => 'pt',
