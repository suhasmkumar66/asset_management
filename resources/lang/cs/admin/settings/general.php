...
return array(
  ...
  'default_language'			=> 'Výchozí jazyk',
    ...
    'load_remote_help_text'		=> 'Tato instalace Asset-IT může nahrávat skripty z vnějšího světa.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Pokud je zde uvedena adresa URL, uživatelé budou po odhlášení ze Asset-IT přesměrování na tuto URL. To je užitečné pro správné ukončení relací Authentication providera.',
    'logo'                    	=> 'Logo',
    ...
    'show_images_in_email_help'   => 'Zrušte zaškrtnutí této kolonky, pokud je instalace Asset-IT za VPN nebo uzavřenou sítí a uživatelé mimo síť nebudou moci do svých e-mailů načíst obrázky z této instalace.',
    ...
    'Asset_version'  			=> 'Verze Asset-IT',
    'support_footer'            => 'Odkazy v zápatí na podporu ',
    'support_footer_help'       => 'Určete, kdo uvidí odkazy na Asset-IT podporu a uživatelskou příručku',
    'version_footer'            => 'Verze v zápatí ',
    'version_footer_help'       => 'Určete kdo uvidí verzi Asset-IT a číslo sestavení.',
    ...
    'width_w'        => 'š',
    'height_h'        => 'v',
    'show_url_in_emails'                => 'Odkaz na Asset-IT v e-mailech',
    'show_url_in_emails_help_text'      => 'Zrušte zaškrtnutí tohoto políčka, pokud nechcete odkazovat zpět na instalaci Asset-IT do vašich emailových patek. Užitečné, pokud se většina vašich uživatelů nikdy nepřihlásí.',
    'text_pt'        => 'pt',
