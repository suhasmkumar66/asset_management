...
return array(
  ...
  'default_language'			=> 'שפת ברירת מחדל',
    ...
    'load_remote_help_text'		=> 'זה Asset-IT להתקין יכול לטעון סקריפטים מהעולם החיצון.',
    ...
    'show_url_in_emails_help_text'      => 'בטל את הסימון בתיבה זו אם אינך רוצה לקשר חזרה את ההתקנה Asset-IT שלך תחתונות הדוא"ל. שימושי אם רוב המשתמשים שלך לא מתחברים.',
    'text_pt'        => 'pt',
