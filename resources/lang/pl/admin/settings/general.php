...
return array(
  ...
  'default_language'			=> 'Domyślny język',
    ...
    'load_remote_help_text'		=> 'Ta instalacja Asset-IT może załadować skrypty z zewnętrznego świata.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Jeżeli URL jest tutaj wpisany, użytkownicy zostaną przekierowani do tego adresu URL po wylogowaniu ze Asset-IT. Jest to przydatne do prawidłowego zamknięcia sesji użytkownika twojego dostawcy uwierzytelniania.',
    'logo'                    	=> 'Logo',
    ...
    'show_images_in_email_help'   => 'Odznacz to pole, jeśli twoja instalacja Asset-IT znajduje się za siecią VPN lub siecią zamkniętą, a użytkownicy spoza sieci nie będą mogli załadować obrazów obsługiwanych przez tę instalację w swoich wiadomościach e-mail.',
    ...
    'Suhas_version'  			=> 'Wersja Asset-IT',
    'support_footer'            => 'Obsługa linków stopki ',
    'support_footer_help'       => 'Określ kto widzi linki do Asset-IT Instrukcji Obsługi oraz Wsparcia',
    'version_footer'            => 'Wersja w stopce ',
    'version_footer_help'       => 'Określ, kto widzi wersję oraz numer kompilacji Asset-IT.',
    ...
    'width_w'        => 'szerokość',
    'height_h'        => 'wysokość',
    'show_url_in_emails'                => 'Połącz się z Asset-IT w wiadomościach e-mail',
    'show_url_in_emails_help_text'      => 'Usuń zaznaczenie tego pola, jeśli nie chcesz łączyć się z instalacją Asset-IT w stopkach wiadomości e-mail. Przydatne, jeśli większość użytkowników nigdy nie loguje się.',
    'text_pt'        => 'piksel',
