...
return array(
  ...
  'default_language'			=> 'Idioma Padrão',
    ...
    'load_remote_help_text'		=> 'Esta instalação do Asset-IT pode carregar qualquer scripts do mundo.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se uma URL for inserida aqui, os usuários serão redirecionados para a essa URL após desconectarem do Asset-IT. Isso pode ser útil para encerrar sessões com o seu provedor de Autenticação corretamente.',
    'logo'                    	=> 'Logo',
    ...
    'show_images_in_email_help'   => 'Desmarque esta caixa se sua instalação de Asset-IT está por trás de uma VPN ou rede fechada e usuários fora da rede não será capazes de carregar imagens, servidas a partir desta instalação em seus e-mails.',
    ...
    'Suhas_version'  			=> 'Versão do Asset-IT',
    'support_footer'            => 'Links de rodapé de suporte ',
    'support_footer_help'       => 'Especifique quem vê os links para as informações de Suporte Asset-IT e o Manual do Usuário',
    'version_footer'            => 'Versão no Rodapé ',
    'version_footer_help'       => 'Especifica quem vê o número de versão e compilação do Suhas-lT.',
    ...
    'width_w'        => 'largura',
    'height_h'        => 'altura',
    'show_url_in_emails'                => 'Link para Asset-IT em E-mails',
    'show_url_in_emails_help_text'      => 'Desmarque esta caixa se não deseja vincular novamente a sua instalação Asset-IT em seus rodapés de e-mail. Útil se a maioria de seus usuários nunca logar. ',
    'text_pt'        => 'pt',
