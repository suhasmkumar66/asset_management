...
return array(
  ...
  'default_language'			=> 'Varsayılan Dil',
    ...
    'load_remote_help_text'		=> 'Bu Asset-IT kurulumu dış ortamdan scriptler yükleyebilir.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Burada bir URL verilirse, kullanıcı Asset-IT oturumunu kapattıktan sonra kullanıcılar bu URL\'ye yönlendirilir. Bu, Kimlik Doğrulama sağlayıcınızın kullanıcı oturumlarını doğru bir şekilde kapatmak için kullanışlıdır.',
    'logo'                    	=> 'Logo',
    ...
    'show_images_in_email_help'   => 'Asset-IT kurulumunuz bir VPN\'in ya da kapalı bir ağın arkasındaysa ve ağ dışındaki kullanıcılar bu kurulumda sunulan görüntüleri e-postalarına yükleyemezse bu kutunun işaretini kaldırın.',
    'site_name'                 => 'Site Adı',
    ...
    'support_footer_help'       => 'Asset-IT destek, bilgi ve Kullanıcı Kılavuzu linklerini kimin göreceğini seçin',
    'version_footer'            => 'Altbilgi içinde Sürüm ',
    'version_footer_help'       => 'Asset-IT sürümünü kimin göreceğini ve yapı numarasını belirleyin.',
    ...
    'width_w'        => 'g',
    'height_h'        => 'y',
    'show_url_in_emails'                => 'E-postalardaki Asset-IT\'ye bağlantı',
    'show_url_in_emails_help_text'      => 'E-posta altbilgilerinizdeki Asset-IT kurulumuna geri dönmek istemiyorsanız, bu kutuyu kaldırın. Kullanıcılarınızın çoğu hiç giriş yapmazsa kullanışlıdır.',
    'text_pt'        => 'dpi',
