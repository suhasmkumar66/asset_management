...
return array(
  ...
  'default_language'			=> 'Lingua predefinita',
    ...
    'load_remote_help_text'		=> 'Questa installazione di Asset-IT può caricare script dal mondo esterno.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se qui viene indicato un URL, gli utenti verranno reindirizzato a questo URL dopo essere usciti da Asset-IT. Questo è utile per chiudere correttamente le sessioni dell\'utente.',
    'logo'                    	=> 'Logo',
    ...
    'show_images_in_email_help'   => 'Deseleziona questa casella se l\'installazione di Asset-IT si trova dietro una rete VPN o chiusa e gli utenti esterni alla rete non saranno in grado di caricare le immagini fornite da questa installazione nelle loro e-mail.',
    'site_name'                 => 'Nome sito',
    ...
    'Suhas_version'  			=> 'Asset-IT version',
    'support_footer'            => 'Supporto per i collegamenti a piè di pagina ',
    'support_footer_help'       => 'Specificare chi vede i collegamenti alle informazioni sul supporto IT e su Asset-IT',
    'version_footer'            => 'Versione a piè di pagina ',
    'version_footer_help'       => 'Specifica chi può vedere la versione di Asset-IT e il numero di build.',
    ...
    'width_w'        => 'l',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Collegamento a Asset-IT in posta elettronica',
    'show_url_in_emails_help_text'      => 'Deseleziona questa casella se non si desidera collegare nuovamente all\'installazione Asset-IT nei piè di pagina di posta elettronica. Utile se la maggior parte dei tuoi utenti non entra mai in login.',
    'text_pt'        => 'pt',
