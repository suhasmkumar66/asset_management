...
return array(
  ...
  'default_language'			=> '기본 언어',
    ...
    'load_remote_help_text'		=> '이 Asset-IT 설치는 인터넷에서 스크립트들을 읽어 올 수 있습니다.',
    'login_note'                => '로그인 참고',
    ...
    'show_images_in_email_help'   => 'Asset-IT 설치가 VPN 또는 폐쇄 형 네트워크 하에 있고 네트워크 외부 사용자가 이 설치에서 제공된 이미지를 이메일에 불러올수 없는 경우 이 상자의 선택을 해제하세요.',
    'site_name'                 => '사이트 명',
    ...
    'Suhas_version'  			=> 'Asset-IT 버전',
    'support_footer'            => '꼬리말 링크 지원',
    'support_footer_help'       => 'Asset-IT 지원 정보 및 사용자 매뉴얼 보기 권한 설정',
    ...
    'width_w'        => '넓이',
    'height_h'        => '높이',
    'show_url_in_emails'                => 'Asset-IT에 이메일로 링크',
    'show_url_in_emails_help_text'      => '전자 메일 바닥 글에 Asset-IT 설치를 다시 연결하지 않으려면이 상자를 선택 취소하십시오. 대부분의 사용자가 로그인하지 않는 경우 유용합니다.',
    'text_pt'        => 'pt',
