...
return array(
  ...
  'default_language'			=> '默认语言',
    ...
    'load_remote_help_text'		=> '允许Asset-IT安装外部的加载脚本。',
    'login_note'                => '登陆提示',
    ...
    'login_remote_user_custom_logout_url_help' => '如果此处提供了URL，则在用户注销Asset-IT后，用户将被重定向到此URL。这对于正确关闭身份验证提供程序的用户会话非常有用。',
    'logo'                    	=> '徽标',
    ...
    'show_images_in_email_help'   => '如果外部用户无法在邮件中通过你安装在VPN或内网的Asset-IT加载图片，请取消此复选框。',
    'site_name'                 => '站点名称',
    ...
    'support_footer_help'       => '指定谁可以看到指向Asset-IT支持信息和用户手册的链接',
    'version_footer'            => '页脚版本 ',
    'version_footer_help'       => '指定谁可以看到Asset-IT版本和内部版本号。',
    'system'                    => '系统信息',
    'update'                    => '更新设置',
    'value'                     => '价值',
    'brand'                     => '品牌',
    ...
    'width_w'        => '宽',
    'height_h'        => '高',
    'show_url_in_emails'                => '链接到Asset-IT在电子邮件',
    'show_url_in_emails_help_text'      => '如果您不希望链接回电子邮件页脚中的Asset-IT安装，请取消选中此框。如果您的大多数用户从未登录，则很有用',
    'text_pt'        => '磅',
