...
return array(
  ...
  'default_language'			=> 'Lenguaje Predeterminado',
    ...
    'load_remote_help_text'		=> 'Esta instalación de Asset-IT puede cargar scripts desde el mundo exterior.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si se proporciona una url aquí, los usuarios serán redirigidos a esta URL después de que el usuario cierre la sesión de Asset-IT. Esto es útil para cerrar correctamente las sesiones de usuario de su proveedor de autenticación.',
    'logo'                    	=> 'Logo',
    ...
    'show_images_in_email_help'   => 'Desmarca esta casilla si tu instalación de Asset-IT está detrás de una red privada o VPN y los usuarios fuera de la red no pueden cargar las imágenes servidas desde este servidor en sus correos electrónicos.',
    ...
    'Suhas_version'  			=> 'Version de Asset-IT',
    'support_footer'            => 'Enlaces de Soporte de Pie de Página ',
    'support_footer_help'       => 'Especifica quién ve los links a la información de Soporte Asset-IT y el Manual de Usuario',
    'version_footer'            => 'Versión en pie de página ',
    'version_footer_help'       => 'Especifica quién ve la versión y el número de compilación de Asset-IT.',
    ...
    'width_w'        => 'an',
    'height_h'        => 'al',
    'show_url_in_emails'                => 'Enlace a Asset-IT en correos electrónicos',
    'show_url_in_emails_help_text'      => 'Desmarca esta casilla si no deseas volver a enlazar a tu instalación Asset-IT en los pie de página de tu correo electrónico. Útil si la mayoría de tus usuarios nunca inicia sesión. ',
    'text_pt'        => 'pt',
