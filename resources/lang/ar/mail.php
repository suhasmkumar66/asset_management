...
return array(
    ...
    'login_first_admin' => 'قم بتسجيل الدخول إلى التثبيت الجديد من Asset-IT باستخدام البيانات أدناه:',
    'login' => 'تسجيل الدخول:',
    ...
    'test_mail_text' => 'يعتبر هذا اختبارا من نظام إدارة الأصول Asset-IT. إذا كنت حصلت على هذا، فان البريد يعمل :)',
